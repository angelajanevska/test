...
{
    public partial class TicketsAndCartModelsMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieTicketShoppingCarts", x => new { x.MovieTicketId, x.ShoppingCartId });
                    table.ForeignKey(
                        name: "FK_MovieTicketShoppingCarts_MovieTickets_ShoppingCartId",
                        column: x => x.ShoppingCartId,
                        principalTable: "MovieTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieTicketShoppingCarts_ShoppingCarts_MovieTicketId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieTicketShoppingCarts_ShoppingCartId",
