...
namespace MovieTicketsWebApp.Domain.Migrations
{
    public partial class MovieTicketsMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieTicketInOrder", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "MovieTicketInShoppingCarts",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MovieTicketId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieTicketInShoppingCarts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieTicketInShoppingCarts_MovieTickets_MovieTicketId",
                        column: x => x.MovieTicketId,
                        principalTable: "MovieTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieTicketInShoppingCarts_ShoppingCards_ShoppingCartId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieTicketInShoppingCarts_ShoppingCartId",
                table: "MovieTicketInShoppingCarts",
